...
async def on_message(message):
    ...
    await hdlr.contMsg("update_integrante", app.updateData, Helpers.updateStruct("integrante", "name"))
    await hdlr.contMsg("update_asistencia", app.updateData, Helpers.updateStruct("asistencia", "id"))
    await hdlr.contMsg("update_evento", app.updateData, Helpers.updateStruct("evento", "name"))
    await hdlr.contMsg("update_rango", app.updateData, Helpers.updateStruct("rango", "name"))
    await hdlr.contMsg("del_integrante", app.deleteData, Helpers.deleteStruct("integrante", "name"))
    await hdlr.contMsg("del_asistencia", app.deleteData, Helpers.deleteStruct("asistencia", "id"))
