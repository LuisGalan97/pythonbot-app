...
@pytest.mark.asyncio
async def testDefault_addAssist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistId_add(capfd):
...
@pytest.mark.asyncio
async def testDefault_updAssistId(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistId(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMember(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistEvent(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistDate(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEvent(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberDate(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistEventDate(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEventDate(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssist_e(capfd):
    commands = [f"$listAssist"]
...
@pytest.mark.asyncio
async def testDefault_listAssistId_e(capfd):
    commands = [f"$listAssist:id[{testData['id']}]",
                f"$listAssist:id [{testData['id']}]",
                f"$listAssist:id [ {testData['id']} ]"]
    eparams = [">e", " >e", " > e", " > e ", " > e FILL"
...
@pytest.mark.asyncio
async def testDefault_listAssistMember_e(capfd):
    commands = [f"$listAssist:member[{testData['memupdate']}]",
                f"$listAssist:member [{testData['memupdate']}]",
                f"$listAssist:member [ {testData['memupdate']} ]"]
    eparams = [">e", " >e", " > e", " > e ", " > e FILL"
...
@pytest.mark.asyncio
async def testDefault_listAssistEvent_e(capfd):
    commands = [f"$listAssist:event[{testData['evupdate']}]",
                f"$listAssist:event [{testData['evupdate']}]",
                f"$listAssist:event [ {testData['evupdate']} ]"]
    eparams = [">e", " >e", " > e", " > e ", " > e FILL"
...
@pytest.mark.asyncio
async def testDefault_listAssistDate_e(capfd):
    commands = [f"$listAssist:date[{testData['dateupdate']},"\
                f"{testData['dateupdate']}]",
                f"$listAssist:date [{testData['dateupdate']}, "\
                f"{testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberDate_e(capfd):
    commands = [f"$listAssist:member&date[{testData['memupdate']},"\
                f"{testData['dateupdate']},{testData['dateupdate']}]",
                f"$listAssist:member&date [{testData['memupdate']}, "\
                f"{testData['dateupdate']}, {testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_listAssistEventDate_e(capfd):
    commands = [f"$listAssist:event&date[{testData['evupdate']},"\
                f"{testData['dateupdate']},{testData['dateupdate']}]",
                f"$listAssist:event&date [{testData['evupdate']}, "\
                f"{testData['dateupdate']}, {testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEventDate_e(capfd):
    commands = [f"$listAssist:member&event&date[{testData['memupdate']},"\
                f"{testData['evupdate']},{testData['dateupdate']},"\
                f"{testData['dateupdate']}]",
                f"$listAssist:member&event&date [{testData['memupdate']}, "\
...
@pytest.mark.asyncio
async def testDefault_delAssistId(capfd):
...
@pytest.mark.asyncio
async def testDefault_addAssist_memberNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_addAssist_eventNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_updAssistId_idNoExist(capfd):
    commands = [f"$updAssist:id[{testData['id']},"
                f"{testData['memupdate']},"\
                f"{testData['evupdate']},"
                f"{testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_updAssistId_memberNoExist(capfd):
    commands = [f"$updAssist:id[{testData['id']},"
...
@pytest.mark.asyncio
async def testDefault_updAssistId_eventNoExist(capfd):
    commands = [f"$updAssist:id[{testData['id']},"
                f"{testData['memupdate']},"\
                f"{testData['evnoexist']},"
                f"{testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_delAssistId_idNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistId_idNoExist(capfd):
    commands = [f"$listAssist:id[{testData['id']}]",
                f"$listAssist:id [{testData['id']}]",
                f"$listAssist:id [ {testData['id']} ] ",
                f"$listAssist:id [ {testData['id']} ]FILL",
...
@pytest.mark.asyncio
async def testDefault_listAssistMember_memberNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistEvent_eventNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistDate_dateNoExist(capfd):
    commands = [f"$listAssist:date[{testData['dateupdate']},"\
                f"{testData['dateupdate']}]",
                f"$listAssist:date [{testData['dateupdate']}, "\
                f"{testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEvent_memberNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEvent_eventNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberDate_memberNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberDate_dateNoExist(capfd):
    commands = [f"$listAssist:member&date[{testData['memupdate']},"\
                f"{testData['dateupdate']},{testData['dateupdate']}]",
                f"$listAssist:member&date [{testData['memupdate']}, "\
                f"{testData['dateupdate']}, {testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_listAssistEventDate_eventNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistEventDate_dateNoExist(capfd):
    commands = [f"$listAssist:event&date[{testData['evupdate']},"\
                f"{testData['dateupdate']},{testData['dateupdate']}]",
                f"$listAssist:event&date [{testData['evupdate']}, "\
                f"{testData['dateupdate']}, {testData['dateupdate']}]",
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEventDate_memberNoExist(capfd):
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEventDate_eventNoExist(capfd):
    commands = [f"$listAssist:member&event&date[{testData['memupdate']},"\
                f"{testData['evnoexist']},{testData['dateupdate']},"\
                f"{testData['dateupdate']}]",
                f"$listAssist:member&event&date [{testData['memupdate']}, "\
...
@pytest.mark.asyncio
async def testDefault_listAssistMemberEventDate_dateNoExist(capfd):
    commands = [f"$listAssist:member&event&date[{testData['memupdate']},"\
                f"{testData['evupdate']},{testData['dateupdate']},"\
                f"{testData['dateupdate']}]",
                f"$listAssist:member&event&date [{testData['memupdate']}, "\
