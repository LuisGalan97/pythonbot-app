...
async def test_listAssistMemberEvent_invalidStruct(capfd):
    commands = ["$listAssist:member&event", "$listAssist:member&event ", 
                ...
                "$listAssist:member&event ]", "$listAssist:member&eventFILL []", 
                "$listAssist:member&event FILL []", "$listAssist:member&event [FILL", 
                "$listAssist:member&event[FILL", "$listAssist:member&event [ FILL", 
                "$listAssist:member&event FILL]", "$listAssist:member&event FILL ] "]
    for command in commands:
        message = Message(author="test", content=command)
...
async def test_listAssistMemberDate_invalidStruct(capfd):
    commands = ["$listAssist:member&date", "$listAssist:member&date ", 
                ...
                "$listAssist:member&date FILL []", "$listAssist:member&date [FILL", 
                "$listAssist:member&date[FILL", "$listAssist:member&date [ FILL", 
                "$listAssist:member&date FILL]", "$listAssist:member&date FILL ] "]
    for command in commands:
        message = Message(author="test", content=command)
        ...
        out, _ = capfd.readouterr()
        assert "El comando debe mantener la forma:" in out
        assert "**listAssist:member&date [_Integrante, Fecha 1, Fecha 2_]**" in out
...
async def test_listAssistEventDate_invalidStruct(capfd):
    commands = ["$listAssist:event&date", "$listAssist:event&date ", 
                ...
                "$listAssist:event&date FILL []", "$listAssist:event&date [FILL", 
                "$listAssist:event&date[FILL", "$listAssist:event&date [ FILL", 
                "$listAssist:event&date FILL]", "$listAssist:event&date FILL ] "]
    for command in commands:
        message = Message(author="test", content=command)
...
async def test_listAssistMemberEventDate_invalidStruct(capfd):
    commands = ["$listAssist:member&event&date", "$listAssist:member&event&date ", 
                "$listAssist:member&event&date[", "$listAssist:member&event&date [", 
                "$listAssist:member&event&dateFILL[", "$listAssist:member&event&date]", 
                "$listAssist:member&event&date ]", "$listAssist:member&event&dateFILL []", 
                "$listAssist:member&event&date FILL []", "$listAssist:member&event&date [FILL", 
                "$listAssist:member&event&date[FILL", "$listAssist:member&event&date [ FILL", 
                "$listAssist:member&event&date FILL]", "$listAssist:member&event&date FILL ] "]
    for command in commands:
        message = Message(author="test", content=command)
        ...
        await hdlr.dFMsg("listAssist:member&event&date", app.getDatas, 
                          Helpers.getStruct("asistencia", ["integrante", "evento", "date_1", "date_2"]))
        out, _ = capfd.readouterr()
        assert "El comando debe mantener la forma:" in out
        assert "**listAssist:member&event&date [_Integrante, Evento, Fecha 1, Fecha 2_]**" in out