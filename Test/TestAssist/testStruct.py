...
@pytest.mark.asyncio
async def testStruct_addAssist_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_updAssistId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_delAssistId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistMember_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistEvent_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistDate_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistMemberEvent_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistMemberDate_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistEventDate_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listAssistMemberEventDate_invalidStruct(capfd):
