...
@pytest.mark.asyncio
async def testParams_addAssist_invalidParams(capfd):
    commands = ["$addAssist[]",
                "$addAssist []",
                "$addAssist[,,,,]",
                "$addAssist [,,,,]",
...
@pytest.mark.asyncio
async def testParams_updAssistId_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_delAssistId_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistId_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistMember_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistEvent_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistDate_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistMemberEvent_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistMemberDate_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistEventDate_invalidParams(capfd):
...
@pytest.mark.asyncio
async def testParams_listAssistMemberEventDate_invalidParams(capfd):
