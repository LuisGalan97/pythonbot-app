...
@pytest.mark.asyncio
async def testStruct_addEvent_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_updEventId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_updEventName_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_delEventId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_delEventName_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listEventId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listEventName_invalidStruct(capfd):
