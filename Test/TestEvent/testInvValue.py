...
@pytest.mark.asyncio
async def test_updEventName_name_empty(capfd):
    value = ""
...
@pytest.mark.asyncio
async def test_updEventName_name_long(capfd):
    value = "abcdefghijklmnñopkrstuvwxyz"\
            "abcdefghijklmnñopkrstuvwxyz"
    commands = [f"$updEvent:name[{value},"\
                f"{testData['points']},"\
...
@pytest.mark.asyncio
async def test_updEventName_name_startchar(capfd):
    values = ["1test", "[test", "{test", "/test", "|test",
             "@test", "*test"]
    for value in values:
        commands = [f"$updEvent:name[{value},"\
...
@pytest.mark.asyncio
async def test_updEventName_name_spechar(capfd):
    values = ["test/", "test{", "te/st", "te\\st",
              "tes@t", "tes*t", "tes--t", "tes||t"]
    for value in values:
        commands = [f"$updEvent:name[{value},"\
...
@pytest.mark.asyncio
async def test_updEventName_name_repeatchar(capfd):
    values = ["t-e-s-t", "t|e|s|t", "t[e[st", "t]e]st"]
    for value in values:
        commands = [f"$updEvent:name[{value},"\
                    f"{testData['points']},"\
...
@pytest.mark.asyncio
async def test_updEventName_points_empty(capfd):
    value = ""
...
@pytest.mark.asyncio
async def test_updEventName_points_invalid(capfd):
    value = "test"
    commands = [f"$updEvent:name[{testData['name']},"\
                f"{value},"\
                f"{testData['desc']}]",
...
@pytest.mark.asyncio
async def test_updEventName_description_empty(capfd):
    value = ""
    commands = [f"$updEvent:name[{testData['name']},"\
                f"{testData['points']},"\
                f"{value}]",
...
@pytest.mark.asyncio
async def test_updEventName_description_long(capfd):
    value = "abcdefghijklmnñopkrstuvwxyz"\
            "abcdefghijklmnñopkrstuvwxyz"
    commands = [f"$updEvent:name[{testData['name']},"\
                f"{testData['points']},"\
...
@pytest.mark.asyncio
async def test_updEventName_description_startchar(capfd):
    values = ["1test", "[test", "{test", "/test", "|test",
             "@test", "*test"]
    for value in values:
        commands = [f"$updEvent:name[{testData['name']},"\
...
@pytest.mark.asyncio
async def test_updEventName_description_spechar(capfd):
    values = ["test/", "test{", "te/st", "te\\st",
              "tes@t", "tes*t", "tes--t", "tes||t"]
    for value in values:
        commands = [f"$updEvent:name[{testData['name']},"\
...
@pytest.mark.asyncio
async def test_updEventName_description_repeatchar(capfd):
    values = ["t-e-s-t", "t|e|s|t", "t[e[st", "t]e]st"]
    for value in values:
        commands = [f"$updEvent:name[{testData['name']},"\
                    f"{testData['points']},"\
...
#-------------------------------$delEvent:id [ID]------------------------------
@pytest.mark.asyncio
async def test_delEventId_id_empty(capfd):
    value = ""
...
@pytest.mark.asyncio
async def test_delEventId_id_invalid(capfd):
    value = "test"
    commands = [f"$delEvent:id[{value}],",
                f"$delEvent:id [{value} ], ",
                f"$delEvent:id [ {value} ], ",
...
#------------------------------$listEvent:id [ID]------------------------------
@pytest.mark.asyncio
async def test_listEventId_id_empty(capfd):
    value = ""
...
@pytest.mark.asyncio
async def test_listEventId_id_invalid(capfd):
    value = "test"
    commands = [f"$listEvent:id[{value}],",
                f"$listEvent:id [{value} ], ",
                f"$listEvent:id [ {value} ], ",
...
@pytest.mark.asyncio
async def test_listEventName_name_empty(capfd):
    value = ""
...
@pytest.mark.asyncio
async def test_listEventName_name_long(capfd):
    value = "abcdefghijklmnñopkrstuvwxyz"\
            "abcdefghijklmnñopkrstuvwxyz"
    commands = [f"$listEvent:name[{value}]",
                f"$listEvent:name [{value} ]",
...
@pytest.mark.asyncio
async def test_listEventName_name_startchar(capfd):
    values = ["1test", "[test", "{test", "/test", "|test",
             "@test", "*test"]
    for value in values:
        commands = [f"$listEvent:name[{value}]",
...
@pytest.mark.asyncio
async def test_listEventName_name_spechar(capfd):
    values = ["test/", "test{", "te/st", "te\\st",
              "tes@t", "tes*t", "tes--t", "tes||t"]
    for value in values:
        commands = [f"$listEvent:name[{value}]",
...
@pytest.mark.asyncio
async def test_listEventName_name_repeatchar(capfd):
    values = ["t-e-s-t", "t|e|s|t", "t[e[st", "t]e]st"]
    for value in values:
        commands = [f"$listEvent:name[{value}]",
                    f"$listEvent:name [{value} ]",
