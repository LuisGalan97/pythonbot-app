...
#-------------------Test $addMember [*, Rango, Principal,*]--------------------
@pytest.mark.asyncio
async def testMemberValue_addMember_principalEmpty(capfd):
    value = ""
    commands = [f"$addMember[{testData['name']},"\
                f"{testData['range']},"\
                f"{value},"\
...
@pytest.mark.asyncio
async def testMemberValue_addMember_principalStartChar(capfd):
    values = ["1test", "[test", "{test", "/test", "|test",
             "@test", "*test"]
    for value in values:
        commands = [f"$addMember[{testData['name']},"\
...
@pytest.mark.asyncio
async def testMemberValue_addMember_principalSpeChar(capfd):
    values = ["test/", "test{", "te/st", "te\\st",
              "tes@t", "tes*t", "tes--t", "tes||t"]
    for value in values:
        commands = [f"$addMember[{testData['name']},"\
...
@pytest.mark.asyncio
async def testMemberValue_addMember_principalRepeatChar(capfd):
    values = ["t-e-s-t", "t|e|s|t", "t[e[st", "t]e]st"]
    for value in values:
        commands = [f"$addMember[{testData['name']},"\
                    f"{testData['range']},"\
...
#-------------------Test $updMember:name [*, *, Principal, *]------------------
@pytest.mark.asyncio
async def testMemberValue_updMemberName_principalEmpty(capfd):
    value = ""
    commands = [f"$updMember:name[{testData['name']},"\
                f"{testData['range']},"\
                f"{value},"\
...
@pytest.mark.asyncio
async def testMemberValue_updMemberName_principalLong(capfd):
    value = "abcdefghijklmnñopkrstuvwxyz"\
            "abcdefghijklmnñopkrstuvwxyz"
    commands = [f"$updMember:name[{testData['name']},"\
                f"{testData['range']},"\
...
@pytest.mark.asyncio
async def testMemberValue_updMemberName_principalStartChar(capfd):
    values = ["1test", "[test", "{test", "/test", "|test",
             "@test", "*test"]
    for value in values:
        commands = [f"$updMember:name[{testData['name']},"\
...
@pytest.mark.asyncio
async def testMemberValue_updMemberName_principalSpeChar(capfd):
    values = ["test/", "test{", "te/st", "te\\st",
              "tes@t", "tes*t", "tes--t", "tes||t"]
    for value in values:
        commands = [f"$updMember:name[{testData['name']},"\
...
@pytest.mark.asyncio
async def testMemberValue_updMemberName_principalRepeatChar(capfd):
    values = ["t-e-s-t", "t|e|s|t", "t[e[st", "t]e]st"]
    for value in values:
        commands = [f"$updMember:name[{testData['name']},"\
                    f"{testData['range']},"\
