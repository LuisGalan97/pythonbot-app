...
@pytest.mark.asyncio
async def testValue_addEvent_dateriptionLong(capfd):
    value = "abcdefghijklmnñopkrstuvwxyz"\
            "abcdefghijklmnñopkrstuvwxyz"
    commands = [f"$addEvent[{testData['name']},"\
                f"{testData['range']},"\
...
@pytest.mark.asyncio
async def testValue_addEvent_dateriptionStartChar(capfd):
    values = ["1test", "[test", "{test", "/test", "|test",
             "@test", "*test"]
    for value in values:
        commands = [f"$addEvent[{testData['name']},"\
...
@pytest.mark.asyncio
async def testValue_addEvent_dateriptionSpeChar(capfd):
    values = ["test/", "test{", "te/st", "te\\st",
              "tes@t", "tes*t", "tes--t", "tes||t"]
    for value in values:
        commands = [f"$addEvent[{testData['name']},"\
...
@pytest.mark.asyncio
async def testValue_addEvent_dateriptionRepeatChar(capfd):
    values = ["t-e-s-t", "t|e|s|t", "t[e[st", "t]e]st"]
    for value in values:
        commands = [f"$addEvent[{testData['name']},"\
                    f"{testData['range']},"\
...
@pytest.mark.asyncio
async def testValue_updEventId_rangeEmpty(capfd):
    value = ""
    commands = [f"$updEvent:id[{testData['id']},"
                f"{testData['name']},"\
                f"{value},"\
...
@pytest.mark.asyncio
async def testValue_updEventId_rangeInvalid(capfd):
    value = "test"
    commands = [f"$updEvent:id[{testData['id']},"
                f"{testData['name']},"\
                f"{value},"\
...
@pytest.mark.asyncio
async def testValue_updEventId_dateriptionEmpty(capfd):
    value = ""
    commands = [f"$updEvent:id[{testData['id']},"
                f"{testData['name']},"\
                f"{testData['range']},"\
...
@pytest.mark.asyncio
async def testValue_updEventId_dateriptionLong(capfd):
    value = "abcdefghijklmnñopkrstuvwxyz"\
            "abcdefghijklmnñopkrstuvwxyz"
    commands = [f"$updEvent:id[{testData['id']},"
                f"{testData['name']},"\
...
@pytest.mark.asyncio
async def testValue_updEventId_dateriptionStartChar(capfd):
    values = ["1test", "[test", "{test", "/test", "|test",
             "@test", "*test"]
    for value in values:
        commands = [f"$updEvent:id[{testData['id']},"
...
@pytest.mark.asyncio
async def testValue_updEventId_dateriptionSpeChar(capfd):
    values = ["test/", "test{", "te/st", "te\\st",
              "tes@t", "tes*t", "tes--t", "tes||t"]
    for value in values:
        commands = [f"$updEvent:id[{testData['id']},"
...
@pytest.mark.asyncio
async def testValue_updEventId_dateriptionRepeatChar(capfd):
    values = ["t-e-s-t", "t|e|s|t", "t[e[st", "t]e]st"]
    for value in values:
        commands = [f"$updEvent:id[{testData['id']},"
                    f"{testData['name']},"\
