...
@pytest.mark.asyncio
async def testStruct_addMember_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_updMemberId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_updMemberName_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_delMemberId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_delMemberName_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listMemberId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listMemberName_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listMemberRange_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testStruct_listMemberDate_invalidStruct(capfd):
