...
@pytest.mark.asyncio
async def testCom_addRange_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testCom_updRangeId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testCom_updRangeName_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testCom_delRangeId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testCom_delRangeName_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testCom_listRangeId_invalidStruct(capfd):
...
@pytest.mark.asyncio
async def testCom_listRangeName_invalidStruct(capfd):
