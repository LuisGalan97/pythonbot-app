...
@pytest.mark.asyncio
async def test_addRange_invalidParams(capfd):
    commands = ["$addRange[]",
                "$addRange []",
                "$addRange[,,,,]",
                "$addRange [,,,,]",
...
@pytest.mark.asyncio
async def test_updRangeId_invalidParams(capfd):
...
@pytest.mark.asyncio
async def test_updRangeName_invalidParams(capfd):
...
@pytest.mark.asyncio
async def test_delRangeId_invalidParams(capfd):
...
@pytest.mark.asyncio
async def test_delRangeName_invalidParams(capfd):
...
@pytest.mark.asyncio
async def test_listRangeId_invalidParams(capfd):
...
@pytest.mark.asyncio
async def test_listRangeName_invalidParams(capfd):
